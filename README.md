A python script that fetches live cricket commentary from a source(I've used ESPN Cricinfo, can change the URL), and sends it to a contact on Whatsapp automatically, at regular intervals.
